...
// // Example usage after creating an invoice
// async function createInvoice(invoiceData) {
//   // Your existing invoice creation logic...

//   // After successfully creating the invoice
//   const customerPhone = invoiceData.customer.phone; // Get customer's phone number
//   const invoiceDetails = `Invoice Number: ${invoiceData.invoiceNumber}\nTotal: ₹${invoiceData.total}\nDate: ${invoiceData.date}`;
//   const smsMessage = `Hello ${invoiceData.customer.name}, your invoice has been created successfully!\n${invoiceDetails}`;

//   await sendSms(customerPhone, smsMessage); // Send SMS to the customer
// }
